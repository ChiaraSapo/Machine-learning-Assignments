...
% This function implements a perceptron (single-unit) neural network
% Inputs: x_total: structure with n training sets and n test sets
%         eta: learning rate
%         num_sets: how many training+test sets are given in x-total 
% Outputs: myconfusionMatrix: confusion matrix
%          w: weight matrix
